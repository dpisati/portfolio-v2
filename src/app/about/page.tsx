      ...
      <Row fillWidth s={{ direction: "column" }} horizontal="center">
        {about.avatar.display && (
          <Column
            ...
            fitHeight
            position="sticky"
            s={{ position: "relative", style: { top: "auto", paddingTop: "40px" } }}
            xs={{ style: { top: "auto", paddingTop: "40px" } }}
            minWidth="160"
            paddingX="l"
            paddingBottom="xl"
            gap="m"
            ...
            <>
              ...
              >
                {about.technical.skills.map(({ title, src }) => (
                  ...
                  >
                    <SkillIcon title={title} src={src || "/images/icons/react.png"} />
                    <Text as="span" variant="body-default-m" align="center" wrap="balance">
                      {title}
                    </Text>
                  </Column>
                ))}
